-- GUI
ModLoader.SetupFileHook("lua/Hud/Marine/GUIMarineHUD.lua", "lua/BetterUI/GUI/GUIMarineHUD.lua", "post")
ModLoader.SetupFileHook("lua/GUIAlienHUD.lua", "lua/BetterUI/GUI/GUIAlienHUD.lua", "post")
